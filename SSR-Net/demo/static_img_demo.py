...
def main():
    ...
    input_img = cv2.imread('image/haha.jpg')
    ...
    if img_idx == 1 or img_idx % skip_frame == 0:
        ...
        input_img, time_network, time_plot = draw_results(detected, input_img, faces, ad, img_size, img_w, img_h,
                                                          model, model_gender, time_detection, time_network,
                                                          time_plot)
